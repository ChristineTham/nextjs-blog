                ...
                <div className="flex items-center grow shrink-0 lg:grow-0">
                  <div className="flex items-center justify-between w-full md:w-auto">
                    ...
                    <div className="-mr-2 flex items-center md:hidden">
                      <button
                        type="button"
                        className="bg-white rounded-md p-2 inline-flex items-center justify-center text-rosely10 hover:text-white hover:bg-rosely9 focus:outline-hidden focus:ring-2 focus:ring-inset focus:ring-rosely3"
                        id="main-menu"
                        aria-haspopup="true"
                ...
                <div className="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                  <div className="px-5 pt-4 flex items-center justify-between">
                    ...
                    <div className="-mr-2">
                      <button
                        type="button"
                        className="bg-white rounded-md p-2 inline-flex items-center justify-center text-rosely10 hover:text-white hover:bg-rosely9 focus:outline-hidden focus:ring-2 focus:ring-inset focus:ring-rosely10"
