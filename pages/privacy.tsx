  ...
  <Layout>
      ...
      <div className="container mx-auto flex px-5 py-16 md:flex-row flex-col items-center rounded-lg shadow-xl bg-rosely4">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-6 flex flex-col items-start">
          ...
          <p className="mt-6 text-rosely1 text-lg tracking-wide">
            <em>
              The European Union (EU) General Data Protection Regulation (GDPR) is a first step
              toward giving EU citizens and residents more control over how their data are used by
              organizations. This is a GPDR compliant privacy notice for this site, which is
              required as this website may be visited by people residing in the EU.
            </em>
          </p>
        </div>
    ...
    <main className="mt-8 md:mt-10 pb-40 relative bg-white">
      <article className="prose mx-auto">
        ...
        <p>
          This website is a personal website owned by Chris Tham. For contact details, please refer
          to the <A href="/contact">Contact page</A> on this website.
        </p>
        ...
        <p>
          We reserve the right to change this privacy policy and implement user data collection for
          the purposes of providing features such as usage tracking, memberships, subscriptions,
          commenting, and any other feature consistent with the stated purpose of this website which
          is in the <A href="/about">About page</A>. If we do so, we will change this Privacy Policy
        ...
        <ul>
          <li>
            <em>The right to access</em> &mdash; You have the right to request us for copies of your
            personal data. However, we currently do not collect any data.
          </li>
          <li>
            <em>The right to rectification</em> &mdash; You have the right to request that we
            correct any information you believe is inaccurate. You also have the right to request we
            complete the information you believe is incomplete. Please use the form in{' '}
          ...
          <li>
            <em>The right to restrict processing</em> &mdash; You have the right to request that we
            restrict the processing of your personal data, under certain conditions. We currently do
        ...
        <p>
          ...
          information, visit <A href="https://allaboutcookies.org">allaboutcookies.org</A>.
        </p>
        <h2>How do we use cookies?</h2>
        <p>
          We currently do not explicitly use cookies in our website. However, we do use third party
          npm packages that may implement cookies. Please refer to the{' '}
