              ...
              <>
                ...
                <div className="relative">
                  <span className="inline-block w-full rounded-md shadow-sm">
                    <Listbox.Button className="cursor-default relative w-full rounded-md border border-rosely3 bg-rosely4 pl-3 pr-10 py-2 text-left focus:outline-none focus:shadow-outline-blue focus:border-rosely7 transition ease-in-out duration-150 sm:text-sm sm:leading-5">
                  ...
                  <Transition
                    ...
                    leaveTo="opacity-0"
                    className="absolute mt-1 w-full rounded-md bg-rosely5 shadow-lg"
                  >
                    <Listbox.Options
                      static
