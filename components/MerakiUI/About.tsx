...
const About: React.FC = () => (
  <section className="bg-rosely2">
    <div className="container mx-auto px-6 py-8">
      <div className="lg:flex items-center">
        <div className="lg:w-1/2">
          <h2 className="text-rosely6 text-3xl font-bold">Who | Why</h2>
          <p className="text-white lg:max-w-md mt-4">
          ...
          <div className="flex items-center -mx-2 mt-6">
            <a className="mx-2" href={site.twitter} aria-label="Twitter">
              <svg
                className="fill-current text-rosely4 hover:text-rosely8 h-6 w-6"
            ...
            <a className="mx-2" href={site.facebook} aria-label="Facebook">
              <svg
                className="fill-current text-rosely4 hover:text-rosely8 h-6 w-6"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
            ...
            <a className="mx-2" href={site.linkedin} aria-label="LinkedIn">
              <svg
                className="fill-current text-rosely4 hover:text-rosely8 h-6 w-6"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
            ...
            <a className="mx-2" href={site.github} aria-label="Github">
              <svg
                className="fill-current text-rosely4 hover:text-rosely8 h-6 w-6"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
        ...
        <div className="mt-8 lg:mt-0 lg:w-1/2">
          <div className="flex flex-col items-center justify-center lg:justify-end">
            ...
            <h2 className="font-medium title-font mt-4 text-rosely6">Chris Tham</h2>
            <p className="text-base text-rosely5 italic tracking-wide">
