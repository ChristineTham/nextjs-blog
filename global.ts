export const site = {
  ...
  description:
    'My adventures learning how to build websites and apps in 2020 using auto workflows, modern build tools. Content is pre-rendered and served to a CDN and made dynamic through APIs and serverless functions.',
