...
description: This is a test file, copied from thinkmill.com
author: Chris Tham
...
For italic text use one _asterix_ or one _underscore_.
...
![alt-text](media/markdown.png 'my title'){#myid .imgClass}
_With a caption that spans over several lines._
...
! Notice 1
!
! Please note that you can use **markdown** inside of the notice so you can _format_ your text here.
...
inline \(x = \int\_{0^1}^1(-b \pm \sqrt{b^2-4ac})/(2a)\) math
