...
WordPress is also in the middle of transitioning to a page builder system, and
the front end of WordPress is now as much React as PHP. I can imagine in the
future WordPress may evolve into a page builder React frontend and a PHP
...
NextJS is so *hot* right now, mainly because it is relatively easy to learn,
...
Finally, I *like* building a website in code. I can do anything I want, have
